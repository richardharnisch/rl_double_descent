...
\begin{frame}{Metrics}
    \begin{itemize}
        ...
        \item The FIM is defined as:
              ...
              \end{equation*}
              where $\tau$ is a trajectory sampled from the policy $\pi_\theta$.
...
\begin{frame}{Agents \& Training Setup}
    \begin{itemize}
        \item We train two agent types: A DQN agent and a TRPO agent, both using feedforward neural networks.
